  ...
  dataTable: [
    {
      ...
      SwitchOut: "200",
      Description:
        "Rider #12345678 - Mountainview Terminals Calgary & Ontracks Rail",
    ...
    {
      icon: "icon-green-flag",
      imageUrl: "https://www.banderasnews.com/1510/images/Ferromex.jpg",
      position: 2,
      name: "Helium",
      weight: 4.0026,
      UserType: "vendor",
  ...
  railCarDetails: [
    {
      ...
      Fleet: "Type",
      Notes:
        "This tank car was repared on 01/27/2022. This tank car was repared on 01/27/2022. This tank car was repared on 01/27/2022.",
    },
    {
      CarId: "GATX-127099",
      CarType: "Gondala",
  ...
  attachmentsArray: [
    {
      ...
      Description:
        "Empty box car (GATX1525) with Rider No. CARG - FRC - 2022 - 1 was brought in.",
    ...
    },
    {
      ...
      Description:
        "Empty box car (GATX5522) with Rider No. CARG - FRC - 2022 - 1 was brought in.",
    ...
    },
    {
      File: "Arrival Communication 07/03/2022",
      Description:
        "Loaded covered hopper car (GATX2566) with Rider No. CARG - FRC - 2022 - 1 was brought in",
